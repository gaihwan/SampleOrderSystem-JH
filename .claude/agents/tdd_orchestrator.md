...
[Feature Slice 분해]
       ...
       │
       ▼
[PLAN 단계] ─ RED_PLAN_FS-xx.md 작성
       │  · PLAN.md 전체 계획과 연계하여 해당 Slice 상세 계획 문서 작성
       │  · 테스트 케이스 목록, 설계 결정, 의존성, 인터페이스 명세 포함
       │  · docs 커밋 수행 (RED 전 계획 확정)
       │
       ▼
[RED 전문가] ─ 실패 테스트 작성
       │
...
[GREEN 전문가] ─ 최소 구현
       ...
       ▼
[커밋①] ─ GREEN 상태 스냅샷 커밋 (리뷰 전)
       │  · feat 타입 커밋으로 GREEN 상태를 기록
       │  · 리뷰 전 안전한 복귀점 확보
       │
       ▼
